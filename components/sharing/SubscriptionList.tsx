    ...
    <>
      <style>{`
        ...
        .mkt-search-input {
          ...
          padding: 14px 18px 14px 50px; font-family: 'DM Sans', sans-serif;
          font-size: 14px; font-weight: 400; color: #1a1230; outline: none; transition: border-color 0.2s, box-shadow 0.2s;
        }
