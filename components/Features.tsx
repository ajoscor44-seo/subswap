      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((f, i) => (
            <div
              key={i}
              className="p-8 rounded-[2.5rem] border border-slate-100 hover:border-indigo-600/20 hover:bg-indigo-50/30 transition-all duration-500"
            >
              <div
                className={`h-14 w-14 ${f.color} rounded-2xl flex items-center justify-center text-xl mb-6 shadow-sm`}
              >
