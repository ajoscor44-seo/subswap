    ...
    <>
      <style>{`
        ...
        @media (max-width: 767px) {
          ...
          .wt-grid { grid-template-columns: 1fr; gap: 16px; }

          /* Balance card tighter */
          .wt-balance-card { padding: 24px 20px; }
          .wt-balance-card h3 { font-size: 32px !important; }

          /* Outer padding */
          .wt-outer { padding: 20px 16px !important; }

          /* Header */
          .wt-header { margin-bottom: 16px !important; }
          .wt-header h2 { font-size: 22px !important; }

          /* Quick select 2x2 stays fine on mobile */
          /* Payment methods wrap nicely already */
        }

        @media (max-width: 479px) {
          .wt-balance-card { padding: 20px 16px; }
          .wt-mini-stats { grid-template-columns: 1fr 1fr; }

          /* Make quick amounts 2x2 */
          .wt-quick-grid { grid-template-columns: 1fr 1fr !important; }

          .wt-pay-btn { font-size: 11px; padding: 14px; }
        }
      `}</style>
