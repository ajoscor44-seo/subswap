      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-black text-slate-900 tracking-tight mb-6">
            Our Mission is to{" "}
            <span className="text-indigo-600">Democratize Premium.</span>
          </h1>
          <p className="text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed">
            DiscountZAR was born out of a simple observation: digital
            subscriptions are getting more expensive, yet we often underutilize
            the slots we pay for.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-slate-500 text-lg leading-relaxed">
              Family plans for services like Netflix, Spotify, and Canva are
              designed for sharing, but finding reliable people to share with
              can be a nightmare. Managing payments, credentials, and access is
              a full-time job.
            </p>
            <h2 className="text-3xl font-black text-slate-900">Our Solution</h2>
            <p className="text-slate-500 text-lg leading-relaxed">
              DiscountZAR provides a secure, automated marketplace where
              subscription owners can sell their unused slots to verified users.
              We handle the payments, the credential security, and the access
              management, so you just enjoy the premium experience.
            </p>
          </div>
            ...
            <div className="relative z-10 space-y-8">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                ...
                <p className="text-slate-500 text-sm">
                  We never expose master passwords. Access is granted through
                  private profiles.
                </p>
              </div>
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                ...
                <p className="text-slate-500 text-sm">
                  Subscription owners get paid instantly when a slot is
                  purchased.
                </p>
              </div>
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                ...
                <p className="text-slate-500 text-sm">
                  Every user on DiscountZAR is verified to ensure a premium
