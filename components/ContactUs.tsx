        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20">
          <div>
            ...
            <p className="text-xl text-slate-500 mb-12 leading-relaxed">
              Have questions about how sharing works? Or need help with your
              access? Our support team is here for you 24/7.
            </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    type="text"
                    required
                    className="w-full bg-white border border-slate-200 p-4 rounded-xl font-bold focus:ring-2 focus:ring-indigo-500 outline-none transition-all"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest text-slate-400">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    required
                    className="w-full bg-white border border-slate-200 p-4 rounded-xl font-bold focus:ring-2 focus:ring-indigo-500 outline-none transition-all h-32"
                  ></textarea>
                </div>
                <button
                  type="submit"
                  className="w-full bg-slate-900 text-white py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-indigo-600 transition-all shadow-xl shadow-slate-200"
                >
                  Send Message
                </button>
              </form>
